...
namespace WorldCities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<ActionResult> Import()
        {
            ...
            // containing all the countries currently existing
            // into the DB (it will be empty on first run).
            var countriesByName = await _context.Countries.AsNoTracking()
            ...
            // create a lookup dictionary containing
            // all the cities already existing into
            // the database (it will be empty on the first run).
